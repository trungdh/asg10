...
public class StringBufferInsert{
	public static void main( String args[] ){
		...
		buffer.deleteCharAt( 9 ); // delete 5 in 2.5 
		buffer.deleteCharAt( 8 ); // delete . in 2.
		...
		sb.reverse();
		System.out.println("\nchuoi dao nguoc: "+a + sb);
		
		// dao nguoc chuoi dung vong lap
		for(int i=a.length()-1; i>=0; i--){
			System.out.println("chuoi dao nguoc: "+ a.charAt(i));
		}
	} // end main
